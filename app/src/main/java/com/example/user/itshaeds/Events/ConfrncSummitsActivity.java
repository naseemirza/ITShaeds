package com.example.user.itshaeds.Events;
...
public class ConfrncSummitsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_confrnc_summits);
    ...
    private void parseJSON1() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://www.itshades.com/appwebservices/event.php?cat_id="+CatId,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            mExampleAdapter1 = new LnDAdapter(ConfrncSummitsActivity.this, mExampleList1);
