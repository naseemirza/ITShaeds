...
public class ITConsltAndServActivity extends AppCompatActivity {
    ...
    private void parseJSON1() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://www.itshades.com/appwebservices/solution.php?cat_id="+CatId,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            mExampleAdapter1 = new SoluAdapter(ITConsltAndServActivity.this, mExampleList1);
