...
public class CustSuccStoriesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cust_succ_stories);
    ...
    private void parseJSON1() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://www.itshades.com/appwebservices/artifacts.php?cat_id="+CatId,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            mExampleAdapter1 = new ArtfAdapter(CustSuccStoriesActivity.this, mExampleList1);
