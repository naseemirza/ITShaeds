...
import com.example.user.itshaeds.CurrentJobActivity;
import com.example.user.itshaeds.JobsActivity;
import com.example.user.itshaeds.LearningActivity;
...
import com.example.user.itshaeds.SolutionsActivity;
