...
/**
 * Created by User on 06-Aug-18.
 */

public class CrntJobsAdapter extends RecyclerView.Adapter<CrntJobsAdapter.ProductViewHolder>  {

    private Context mCtx;
    private List<JobsModelName> productList1;

    public CrntJobsAdapter(Context mCtx, List<JobsModelName> productList1) {
        this.mCtx = mCtx;
    ...
    @Override
    public CrntJobsAdapter.ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //inflating and returning our view holder
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.crntjobslayout,parent, false);
        return new CrntJobsAdapter.ProductViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final CrntJobsAdapter.ProductViewHolder holder, int position) {
