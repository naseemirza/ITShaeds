package com.example.user.itshaeds.ITByteDetailsRecy;
...
import com.example.user.itshaeds.ITBytes.ITbytdetalsmodel;
...
public class RewardAndRecogActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reward_and_recog);
