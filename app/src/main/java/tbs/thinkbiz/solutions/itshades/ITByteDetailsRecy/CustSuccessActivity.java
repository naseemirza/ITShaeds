...
public class CustSuccessActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(tbs.thinkbiz.solutions.itshades.R.layout.activity_cust_success);
...
//        });
        ...
        termsndcond.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(CustSuccessActivity.this,TermsActivity.class));
            }
        });
        ...
        prvynspolcy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(CustSuccessActivity.this,PrevayActivity.class));
            }
        });
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            mExampleAdapter1 = new ITbytdetailsAdapter(CustSuccessActivity.this, mExampleList1);
