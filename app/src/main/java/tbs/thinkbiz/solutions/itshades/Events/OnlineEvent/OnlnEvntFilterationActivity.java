...
import tbs.thinkbiz.solutions.itshades.Events.ConfSumm.FilterationConfSummActivity;
import tbs.thinkbiz.solutions.itshades.R;

public class OnlnEvntFilterationActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_onln_evnt_filteration);
        ...
        btnsrch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(OnlnEvntFilterationActivity.this, OnlnEvntFilterActivity.class);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            spinerInd.setAdapter(new ArrayAdapter<String>(OnlnEvntFilterationActivity.this, R.layout.spinneritems, Indst));
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            spinerFA.setAdapter(new ArrayAdapter<String>(OnlnEvntFilterationActivity.this,R.layout.spinneritems, FocusArea));
