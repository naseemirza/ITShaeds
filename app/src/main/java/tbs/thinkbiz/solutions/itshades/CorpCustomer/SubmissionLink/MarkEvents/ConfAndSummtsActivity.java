...
public class ConfAndSummtsActivity extends AppCompatActivity {
    ...
    private EvntListAdapter mExampleAdapter;
    private ArrayList<EvntListModel> mExampleList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_conf_and_summts);
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                edit.commit();
                Intent intent=new Intent(ConfAndSummtsActivity.this,MarktngEvntsActivity.class);
                startActivity(intent);
            }
        });

        addconfnsmts=(Button)findViewById(R.id.addnewjob);
        addconfnsmts.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                String actname="Add New Conferences & Summits";
                ...
                Intent intent=  new Intent(ConfAndSummtsActivity.this,AddNewConfnSumtActivity.class);
                startActivity(intent);
            }
        });
        //TableData
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < rootJsonArray.length(); i++) {
                                ...
                                mExampleList.add(new EvntListModel(object.optString("id"),
                            ...
                            mExampleAdapter = new EvntListAdapter(ConfAndSummtsActivity.this, mExampleList);
