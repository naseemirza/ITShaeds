...
import tbs.thinkbiz.solutions.itshades.LearningAndDevelopment.LndFilterActivity;
import tbs.thinkbiz.solutions.itshades.LearningAndDevelopment.LndFilterationActivity;
import tbs.thinkbiz.solutions.itshades.R;

public class ArtfacFiltrationActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener   {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_artfac_filtration);
        ...
        btnsrch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(ArtfacFiltrationActivity.this, ArtfacFilterActivity.class);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            spinerInd.setAdapter(new ArrayAdapter<String>(ArtfacFiltrationActivity.this, R.layout.spinneritems, Indst));
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            spinerFA.setAdapter(new ArrayAdapter<String>(ArtfacFiltrationActivity.this,R.layout.spinneritems, FocusArea));
