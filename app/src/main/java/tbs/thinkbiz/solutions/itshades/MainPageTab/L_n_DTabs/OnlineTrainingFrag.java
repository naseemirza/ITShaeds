 ...
 */
public class OnlineTrainingFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView=  inflater.inflate(R.layout.fragment_online_training, container, false);
        ...
        floatingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               // String CatId="1";
                String details="Online Training";
