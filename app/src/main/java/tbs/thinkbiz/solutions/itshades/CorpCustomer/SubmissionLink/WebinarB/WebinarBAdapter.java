package tbs.thinkbiz.solutions.itshades.CorpCustomer.SubmissionLink.WebinarB;
...
public class WebinarBAdapter extends RecyclerView.Adapter<WebinarBAdapter.ProductViewHolder> {

    private Context mCtx;
    private List<WebinarBModel> productList;


    public WebinarBAdapter(Context mCtx, List<WebinarBModel> productList) {
        this.mCtx = mCtx;
        this.productList = productList;
    }

    @Override
    public WebinarBAdapter.ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //inflating and returning our view holder
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.webinarb_layout,parent, false);
        return new WebinarBAdapter.ProductViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final WebinarBAdapter.ProductViewHolder holder, int position) {
        final WebinarBModel product = productList.get(position);
        ...
        holder.tvaction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v ) {
                ...
                edit.commit();
                Intent intent = new Intent(v.getContext(), WebinarEditActivity.class);
