...
public class PremiumUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(PremiumUserActivity.this, MyProfileActivity.class);
        ...
        String url= "https://www.itshades.com/appwebservices/add-details.php?uid="+uid;
    ...
    private class MyWebViewClient extends WebViewClient {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            progressDialog = new ProgressDialog(PremiumUserActivity.this);
