...
public class BlogAdapter extends RecyclerView.Adapter<BlogAdapter.ProductViewHolder> {

    private Context mCtx;
    private List<BlogModel> productList;


    public BlogAdapter(Context mCtx, List<BlogModel> productList) {
        this.mCtx = mCtx;
        this.productList = productList;
    }

    @Override
    public BlogAdapter.ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //inflating and returning our view holder
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.blog_layout, parent, false);
        return new BlogAdapter.ProductViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final BlogAdapter.ProductViewHolder holder, int position) {
        final BlogModel product = productList.get(position);
        ...
        holder.tvaction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                edit.commit();
                Intent intent = new Intent(v.getContext(), BlogEditActivity.class);
...
//        public TextView tvuserprice;
        ...
        public ProductViewHolder(final View itemView) {
            ...
            tvdesc = itemView.findViewById(R.id.email);
