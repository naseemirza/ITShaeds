 ...
 */
public class ConfAndSumtsFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView= inflater.inflate(R.layout.fragment_conf_and_sumts, container, false);
        ...
        floatingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String details="Conferences & Summits";
                ...
                edit.apply();
                Intent intent=new Intent(getActivity(),FilterationConfSummActivity.class);
