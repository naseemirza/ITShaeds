...
public class FilterWebnrActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_filter_webnr);
    ...
    private void parseJSON1() {
        ...
        String OnlnEvntUrl="https://www.itshades.com/appwebservices/webinar.php?industry="+ind+"&item="+fa+"&title_search="+editxt;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            mExampleAdapter1 = new ConfSummAdapter(FilterWebnrActivity.this, mExampleList1);
