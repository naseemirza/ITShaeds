...
import tbs.thinkbiz.solutions.itshades.CorpCustomer.Profile.InviteFrndsActivity;
...
public class OnlineTranPortalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url= "https://www.itshades.com/appwebservices/online-training-portals.php?uid="+uid;
    ...
    private class MyWebViewClient extends WebViewClient {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            progressDialog = new ProgressDialog(OnlineTranPortalActivity.this);
