...
public class SoluListAdapter  extends RecyclerView.Adapter<SoluListAdapter.ProductViewHolder> {

    private Context mCtx;
    private List<SoluListModel> productList;


    public SoluListAdapter(Context mCtx, List<SoluListModel> productList) {
        this.mCtx = mCtx;
        this.productList = productList;
    }

    @Override
    public SoluListAdapter.ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //inflating and returning our view holder
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.list_layoutb, parent, false);
        return new SoluListAdapter.ProductViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final SoluListAdapter.ProductViewHolder holder, int position) {
        final SoluListModel product = productList.get(position);
        ...
        holder.tvaction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v ) {
                ...
                edit.commit();
                Intent intent = new Intent(v.getContext(), SoluEditActivity.class);
