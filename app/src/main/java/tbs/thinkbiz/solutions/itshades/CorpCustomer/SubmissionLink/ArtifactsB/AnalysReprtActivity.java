...
public class AnalysReprtActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_analys_reprt);
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                edit.commit();
                Intent intent=new Intent(AnalysReprtActivity.this,ArtifactsBActivity.class);
...
//            @Override
//            public void onClick(View v) {
//                Intent intent=new Intent(AnalysReprtActivity.this,FilterAllActivity.class);
//                startActivity(intent);
//            }
//        });
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            mExampleAdapter = new ArtListAdapter(AnalysReprtActivity.this, mExampleList);
