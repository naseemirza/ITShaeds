...
public class AddnewJobActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addnew_job);
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               Intent intent=new Intent(AddnewJobActivity.this, JobSubmiActivity.class);
    ...
    private class MyWebViewClient extends WebViewClient {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            progressDialog = new ProgressDialog(AddnewJobActivity.this);
