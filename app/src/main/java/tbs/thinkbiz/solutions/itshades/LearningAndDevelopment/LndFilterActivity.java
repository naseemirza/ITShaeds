...
public class LndFilterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lnd_filter);
    ...
    private void parseJSON1() {
        ...
        String OnlnEvntUrl="https://www.itshades.com/appwebservices/online-training.php?cat_id="+CatId+"&industry="+ind+"&item="+fa+"&title_search="+editxt;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            mExampleAdapter1 = new LnDAdapter(LndFilterActivity.this, mExampleList1);
