...
public class IndsSolutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inds_solut);
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                edit.commit();
                Intent intent=new Intent(IndsSolutActivity.this,SolutionBActivity.class);
        ...
        addonlntrng.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String actname="Add New Industry Solution";
                ...
                Intent intent=  new Intent(IndsSolutActivity.this,AddNewSolutionActivity.class);
                startActivity(intent);
            }
        });
        //TableData
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            mExampleAdapter = new SoluListAdapter(IndsSolutActivity.this, mExampleList);
