...
public class EvntListModel {
    ...
    public EvntListModel(String id, String name, String indsRelv,
                         String focsAra, String userPrice, String addeddate, String status, String action) {
        this.id = id;
        this.name = name;
