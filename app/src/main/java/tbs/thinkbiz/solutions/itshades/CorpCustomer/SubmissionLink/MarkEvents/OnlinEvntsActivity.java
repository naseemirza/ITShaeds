...
public class OnlinEvntsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_onlin_evnts);
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                edit.commit();
                Intent intent=new Intent(OnlinEvntsActivity.this,MarktngEvntsActivity.class);
                startActivity(intent);
            }
        });
        addOnlnevnt=(Button)findViewById(R.id.addnewjob);
        addOnlnevnt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                String actname="Add New Online Events";
                ...
                Intent intent=  new Intent(OnlinEvntsActivity.this,AddNewOnlnEvntActivity.class);
                startActivity(intent);
            }
        });
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            mExampleAdapter = new EvntListAdapter(OnlinEvntsActivity.this, mExampleList);
