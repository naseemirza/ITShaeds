...
public class ListAdapterB extends RecyclerView.Adapter<ListAdapterB.ProductViewHolder> {

    private Context mCtx;
    private List<ListModelB> productList;


    public ListAdapterB(Context mCtx, List<ListModelB> productList) {
        this.mCtx = mCtx;
    ...
    public ListAdapterB.ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ListAdapterB.ProductViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final ListAdapterB.ProductViewHolder holder, int position) {
        final ListModelB product = productList.get(position);
        ...
        holder.tvaction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v ) {
                ...
                edit.commit();
                Intent intent = new Intent(v.getContext(), LnDCorpEditActivity.class);
