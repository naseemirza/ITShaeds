...
//        });
        ...
        termsndcond.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MiscellaneousActivity.this,TermsActivity.class));
            }
        });
        ...
        prvynspolcy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MiscellaneousActivity.this,PrevayActivity.class));
            }
        });
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            mExampleAdapter1 = new ITbytdetailsAdapter(MiscellaneousActivity.this, mExampleList1);
