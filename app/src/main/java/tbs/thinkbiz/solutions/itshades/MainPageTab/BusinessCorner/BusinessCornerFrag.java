 ...
 */
public class BusinessCornerFrag extends Fragment {

    TabLayout tabLayout;
    ViewPager viewPager;

    public BusinessCornerFrag() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_business_corner, container, false);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new BusnsDrFrag(), "Business Directory");
        adapter.addFragment(new BusnsClassfdFrag(), "Business Classifieds");
        adapter.addFragment(new BusnsRevsFrag(), "Business Reviews");
