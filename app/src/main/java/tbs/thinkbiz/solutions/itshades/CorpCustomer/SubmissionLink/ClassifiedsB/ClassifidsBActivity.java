...
import tbs.thinkbiz.solutions.itshades.CorpCustomer.SubmissionLink.WebinarB.WebinarBAdapter;
import tbs.thinkbiz.solutions.itshades.CorpCustomer.SubmissionLink.WebinarB.WebinarBModel;
import tbs.thinkbiz.solutions.itshades.R;

public class ClassifidsBActivity extends AppCompatActivity {
    ...
    private ClassifiedBAdapter mExampleAdapter;
    private ArrayList<ClassifiedBModel> mExampleList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_classifids_b);
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                edit.commit();
                Intent intent=new Intent(ClassifidsBActivity.this,ParentActivity.class);
                startActivity(intent);
            }
        });

        classifadd=(Button)findViewById(R.id.addnewjob);
        classifadd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                String actname="Add New Classifieds";
                ...
                Intent intent=  new Intent(ClassifidsBActivity.this,AddNewClassBActivity.class);
                startActivity(intent);
            }
        });
    ...
    private void parseJSON() {
        ...
        String Tab_Url= AllUrls.CLASSIFIEDSB+uid;
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < rootJsonArray.length(); i++) {
                                ...
                                mExampleList.add(new ClassifiedBModel(object.optString("id"),
                            ...
                            mExampleAdapter = new ClassifiedBAdapter(ClassifidsBActivity.this, mExampleList);
