...
public class ClassifiedBAdapter extends RecyclerView.Adapter<ClassifiedBAdapter.ProductViewHolder> {

    private Context mCtx;
    private List<ClassifiedBModel> productList;


    public ClassifiedBAdapter(Context mCtx, List<ClassifiedBModel> productList) {
        this.mCtx = mCtx;
        this.productList = productList;
    }

    @Override
    public ClassifiedBAdapter.ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //inflating and returning our view holder
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.webinarb_layout,parent, false);
        return new ClassifiedBAdapter.ProductViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final ClassifiedBAdapter.ProductViewHolder holder, int position) {
        final ClassifiedBModel product = productList.get(position);
        ...
        holder.tvaction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v ) {
                ...
                edit.commit();
                Intent intent = new Intent(v.getContext(), EditClassBActivity.class);
