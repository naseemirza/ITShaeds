 ...
 */
public class CSStoriesFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView= inflater.inflate(R.layout.fragment_csstories, container, false);
        ...
        floatingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // String CatId="3";
                String details="Customer Success Stories";
