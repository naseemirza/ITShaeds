...
public class CompSiteAdapter extends RecyclerView.Adapter<CompSiteAdapter.ProductViewHolder> {

    private Context mCtx;
    private List<CompSiteModel> productList;

    public CompSiteAdapter(Context mCtx, List<CompSiteModel> productList) {
        this.mCtx = mCtx;
        this.productList = productList;
    }

    @Override
    public CompSiteAdapter.ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //inflating and returning our view holder
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.adapter, null);
        return new CompSiteAdapter.ProductViewHolder(view);
    }

    @Override
    public void onBindViewHolder(CompSiteAdapter.ProductViewHolder holder, int position) {
        final CompSiteModel product = productList.get(position);
