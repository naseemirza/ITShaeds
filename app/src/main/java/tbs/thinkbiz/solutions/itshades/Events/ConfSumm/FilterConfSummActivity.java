...
public class FilterConfSummActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_filter_conf_summ2);
    ...
    private void parseJSON1() {
        ...
        String CnfSmtUrl="https://www.itshades.com/appwebservices/inperson-events.php?industry="+ind+"&item="+fa+"&title_search="+editxt;

        StringRequest stringRequest = new StringRequest(Request.Method.GET, CnfSmtUrl,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            mExampleAdapter1 = new ConfSummAdapter(FilterConfSummActivity.this, mExampleList1);
