...
public class ITConsAndServActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_itcons_and_serv);
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                edit.commit();
                Intent intent=new Intent(ITConsAndServActivity.this,SolutionBActivity.class);
        ...
        addonlntrng.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String actname="Add New IT Consulting & Services";
                ...
                Intent intent=  new Intent(ITConsAndServActivity.this,AddNewSolutionActivity.class);
                startActivity(intent);
            }
        });
        //TableData
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            mExampleAdapter = new SoluListAdapter(ITConsAndServActivity.this, mExampleList);
