...
public class WebinarBActivity extends AppCompatActivity {
    ...
    private WebinarBAdapter mExampleAdapter;
    private ArrayList<WebinarBModel> mExampleList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_webinar_b);
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                edit.commit();
                Intent intent=new Intent(WebinarBActivity.this,ParentActivity.class);
                startActivity(intent);
            }
        });


        webinaradd=(Button)findViewById(R.id.addnewjob);
        webinaradd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                String actname="Add New Webinar";
                ...
                Intent intent=  new Intent(WebinarBActivity.this,AddNewWebinarActivity.class);
                startActivity(intent);
            }
        });
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < rootJsonArray.length(); i++) {
                                ...
                                mExampleList.add(new WebinarBModel(object.optString("id"),
                            ...
                            mExampleAdapter = new WebinarBAdapter(WebinarBActivity.this, mExampleList);
