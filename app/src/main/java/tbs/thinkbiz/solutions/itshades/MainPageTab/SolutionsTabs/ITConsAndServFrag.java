 ...
 */
public class ITConsAndServFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView= inflater.inflate(R.layout.fragment_itcons_and, container, false);
       ...
       // CatId=pref.getString("CatId","");
        ...
        floatingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String CatId="2";
                String details="IT Consulting & Services";
    ...
    private void parseJSON1() {
        ...
        //String url="https://www.itshades.com/appwebservices/solution.php?cat_id=2&uid=329";
