...
public class ArtfacFilterActivity extends AppCompatActivity {

    String Actname,ind,fa,editxt,CatId;
    TextView textname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_artfac_filter);
    ...
    private void parseJSON1() {
        ...
        String OnlnEvntUrl="https://www.itshades.com/appwebservices/artifacts.php?cat_id="+CatId+"&industry="+ind+"&item="+fa+"&title_search="+editxt;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            mExampleAdapter1 = new ArtfAdapter(ArtfacFilterActivity.this, mExampleList1);
