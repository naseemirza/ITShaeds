 ...
 */
public class OnDTrainingFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView=  inflater.inflate(R.layout.fragment_on_dtraining, container, false);
        ...
        floatingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               // String CatId="4";
                String details="On Demand Training";
