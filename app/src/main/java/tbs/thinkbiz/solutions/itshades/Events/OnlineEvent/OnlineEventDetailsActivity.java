...
public class OnlineEventDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Contactbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(OnlineEventDetailsActivity.this, ContactForm.class);
    ...
    private void parseJSON1() {
        ...
        String url="https://www.itshades.com/appwebservices/online-event-related.php?id="+id;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            mExampleAdapter1 = new LnDRltdAdapter(OnlineEventDetailsActivity.this, mExampleList1);
    ...
    private void parseJSON() {
        ...
        String Tab_Url="https://www.itshades.com/appwebservices/online-event-detail.php?id="+id;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            mExampleAdapter = new TableAdapter(OnlineEventDetailsActivity.this, mExampleList);
