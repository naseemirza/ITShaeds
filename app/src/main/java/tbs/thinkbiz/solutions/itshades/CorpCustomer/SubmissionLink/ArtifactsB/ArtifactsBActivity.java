...
public class ArtifactsBActivity extends AppCompatActivity {

    List<ArtifactsModelB> productList1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_artifacts_b);
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(ArtifactsBActivity.this, ParentActivity.class);
        ...
        productList1.add(new ArtifactsModelB("Analyst Report"));
        productList1.add(new ArtifactsModelB("White Paper"));
        productList1.add(new ArtifactsModelB("Customer Success Stories"));

        ArtifactsAdapterB adapter1 = new ArtifactsAdapterB(this, productList1);
