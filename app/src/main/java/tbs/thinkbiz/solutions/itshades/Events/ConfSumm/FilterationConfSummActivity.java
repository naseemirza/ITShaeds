...
import tbs.thinkbiz.solutions.itshades.CorpCustomer.SubmissionLink.LearnAndDevlp.Filteration.LnDFiltrationActivity;
...
public class FilterationConfSummActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_filter_conf_summ);
        ...
        btnsrch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(FilterationConfSummActivity.this, FilterConfSummActivity.class);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            spinerInd.setAdapter(new ArrayAdapter<String>(FilterationConfSummActivity.this, R.layout.spinneritems, Indst));
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            spinerFA.setAdapter(new ArrayAdapter<String>(FilterationConfSummActivity.this,R.layout.spinneritems, FocusArea));
