...
import tbs.thinkbiz.solutions.itshades.Events.OnlineEvent.OnlnEvntFilterActivity;
import tbs.thinkbiz.solutions.itshades.Events.OnlineEvent.OnlnEvntFilterationActivity;
import tbs.thinkbiz.solutions.itshades.R;

public class FilterationWebnrActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_filteration_webnr);
        ...
        btnsrch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(FilterationWebnrActivity.this, FilterWebnrActivity.class);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            spinerInd.setAdapter(new ArrayAdapter<String>(FilterationWebnrActivity.this, R.layout.spinneritems, Indst));
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            spinerFA.setAdapter(new ArrayAdapter<String>(FilterationWebnrActivity.this,R.layout.spinneritems, FocusArea));
