 ...
 */
public class ProdAndPlatformsFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView= inflater.inflate(R.layout.fragment_prod_and_platforms, container, false);
        ...
        floatingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String CatId="1";
                String details="Products & Platforms";
    ...
    private void parseJSON1() {
        ...
        //String url="https://www.itshades.com/appwebservices/solution.php?cat_id=1&uid=329";
